...
def display_state(): #edited
	...
	if answer == "y":
		in_temp["type"] = input("Enter type (probe, program, manual):")
		in_temp["temperature"] = input("Enter temp (probe: 140|5|180, else: high, low, warm):")
		in_cook_time["length"] = input("Enter time (program: 00:30|00:30|12:00, else: NA):")
		remote_input = "new"
		time.sleep(2.5)
	else:
		remote_input = "NULL"
